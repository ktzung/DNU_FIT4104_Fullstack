...
### 🟦 Giai đoạn 1: Frontend Foundation (Tuần 1-4)
```
phan_1_frontend_foundation/
├── 01_setup_vue3.md           ← Setup, Composition API
├── 02_pinia_router.md         ← Routing, State Management
├── 03_ui_vuetify.md           ← UI Design, Dashboard
└── 04_axios_service.md        ← HTTP Client, API Pattern
```
...
👉 [Bắt đầu Tuần 1](./phan_1_frontend_foundation/01_setup_vue3.md)
